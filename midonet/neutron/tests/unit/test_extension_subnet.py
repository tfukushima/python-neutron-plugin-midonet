...
class SubnetExtensionTestCase(test_api_v2_extension.ExtensionTestCase):
    ...
    def test_show_subnet(self):
        ...
        self.assertEqual(res['midonet_subnet'], return_value)
    ...
    def test_update_subnet(self):
        ...
        return_value = {'id': subnet_id,
                        ...
                        'interface_mtu': 400,
                        'subnet_length': 24}
        update_data = {'midonet_sunet': {'server_addr': '88.123.43.2'}}
        instance = self.plugin.return_value
        instance.update_subnet.return_value = return_value

        res = self.api.put(
            _get_path('midonet_subnets', id=subnet_id, fmt=self.fmt),
            self.serialize(update_data))
        instance.update_subnet.assert_called_once_with(
